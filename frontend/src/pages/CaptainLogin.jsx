    ...
    return (
        <div className='p-7 h-screen flex  flex-col justify-between'>
            ...
            <form onSubmit={(e) => {submitHandler(e)}}>
                ...
                <div>
                    <Link to='/login' className='bg-[#e8de48] flex items-center justify-center text-white font-semibold mb-7 rounded px-4 py-2 text-lg placeholder:text-base'> Sign in as user
                </Link>
            </div>
        </div>
        )
