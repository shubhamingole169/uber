...
const ConfirmRidePopUp = (props) => {
    ...
    return (
        <div className="flex flex-col min-h-0">
            <h5
                className="p-1 text-center w-full mb-2 cursor-pointer"
            ...
            <div className="w-full">
                <form onSubmit={submitHandler} className="flex flex-col gap-3">
                    ...
                    />
                    <button className="w-full text-lg bg-green-600 text-white font-semibold p-3 rounded-lg">
                        Confirm
                    </button>
                    <button
                        type="button"
                        ...
                        className="w-full text-lg bg-red-600 text-white font-semibold p-3 rounded-lg"
                    >
                        Cancel
                    </button>
                </form>
